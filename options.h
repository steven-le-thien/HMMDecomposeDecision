...
static hmmsearch_options_t 	single_model_search_option 			= {	NULL, 							DEFAULT_SINGLE_HMM_NAME, 		DEFAULT_SINGLE_SEARCH_FLAG, 		DEFAULT_NOALI, 		DEFAULT_E_VAL, 			DEFAULT_HEURISTICS_FILTER}; 
static hmmsearch_options_t 	double_model_fist_search_option 	= {	DEFAULT_DOUBLE_FIRST_MSA_NAME, 	DEFAULT_DOUBLE_FIRST_HMM_NAME, 	DEFAULT_DOUBLE_FIRST_SEARCH_FLAG, 	DEFAULT_NOALI, 		DEFAULT_E_VAL, 			DEFAULT_HEURISTICS_FILTER}; 
static hmmsearch_options_t 	double_model_second_search_option 	= {	DEFAULT_DOUBLE_SECOND_MSA_NAME, DEFAULT_DOUBLE_SECOND_HMM_NAME, DEFAULT_DOUBLE_SECOND_SEARCH_FLAG, 	DEFAULT_NOALI, 		DEFAULT_E_VAL, 			DEFAULT_HEURISTICS_FILTER}; 
