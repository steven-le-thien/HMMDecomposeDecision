// This file has been modified (namely commenting out line 744 and 745) 
// by Thien Le for other uses and may not behave as originally intended by 
// the developers of HMMER. 
